...
const Page = ({ children }) => {
    ...
    const navLinks = [
        ...
        { name: "KV-Dienste finden", href: "/representative/services/marketplace" },
        { name: "Merkliste", href: "/representative/services/watchlist" },
        { name: "Meine Bewerbungen", href: "/representative/services/applications" },
        { name: "Zugewiesene Dienste", href: "/representative/services/assigned" },
        { name: "Beendete Dienste", href: "/representative/services/concluded" },
    ];
