...
const Section2 = () => {
  ...
  return (
    <>
      <div className="px-[60px] mt-2 bg-[#E7EBEF] sm:px-[10px] md:px-[25px] lg:px-[25px] xl:px-[25px] xxl:px-[25px] py-28 flex flex-col gap-8 w-full">
        ...
        <div className="flex sm:flex-col sm:justify-center sm:items-center gap-4 md:flex-wrap md:justify-center md:items-center lg:flex-wrap lg:justify-center xl:flex-wrap xl:justify-center xl:items-center xxl:flex-wrap xxl:justify-center xxl:items-center">
          {/* //Card starting */}
          <Link href={"/customer/services/marketplace"}>
          ...
          {/* //Card ending */}
          {/* //Card starting */}
          <Link href={"/customer/services/assigned"}>
        ...
        <div className="w-full flex h-[74px] rounded-md items-center">
          <div className="bg-[#ED6D05] w-1 h-full rounded-l-full"></div>
          <div className="bg-[#E7DED8] h-full w-full flex items-center">
            <div className="w-6 h-6 mx-4">
              <svg data-v-5a983828="" className="w-full h-full text-[#ED6D05] svg-inline--fa fa-exclamation-circle fa-w-16 mdi v-icon notranslate v-theme--light v-icon--size-default mr-3" aria-hidden="true" focusable="false" data-prefix="fal" data-icon="exclamation-circle" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M256 40c118.621 0 216 96.075 216 216 0 119.291-96.61 216-216 216-119.244 0-216-96.562-216-216 0-119.203 96.602-216 216-216m0-32C119.043 8 8 119.083 8 256c0 136.997 111.043 248 248 248s248-111.003 248-248C504 119.083 392.957 8 256 8zm-11.49 120h22.979c6.823 0 12.274 5.682 11.99 12.5l-7 168c-.268 6.428-5.556 11.5-11.99 11.5h-8.979c-6.433 0-11.722-5.073-11.99-11.5l-7-168c-.283-6.818 5.167-12.5 11.99-12.5zM256 340c-15.464 0-28 12.536-28 28s12.536 28 28 28 28-12.536 28-28-12.536-28-28-28z"></path></svg>
            </div>
            <div className="text-[#ED6D05]">Ihr Profil benötigt Ihre Aufmerksamkeit. Bitte vervollständigen Sie Ihre Daten <Link href={"/"} className='text-[#5B9FC4]'>hier</Link></div>
          </div>
        </div>
      </div>
    </>
