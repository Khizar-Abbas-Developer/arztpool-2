  ...
  return (
    <>
      <div className="px-[110px] bg-[white] sm:px-[10px] md:px-[25px] lg:px-[25px] xl:px-[25px] xxl:px-[25px] py-12 flex flex-col gap-8">
        ...
        <div className="ml-12 flex sm:flex-col sm:justify-center sm:items-center gap-[130px] md:flex-wrap md:justify-center md:items-center lg:flex-wrap lg:justify-center xl:flex-wrap xl:justify-center xl:items-center xxl:flex-wrap xxl:justify-center xxl:items-center">
          {/* //Card starting */}
        ...
        <div className="flex justify-end items-center text-[12px]">*Preise sind Nettopreise (zzgl. 19% USt.)</div>
      </div>
    </>
  )
}
