...
const Page = () => {
  const arrayToLoop = [1, 2, 3, 4, 5, 6, 7];
  return (
    <>
      <div className="pt-20 pl-16">
        <div className="text-[24px] mb-8 font-[600] text-[#173968]">Mir zugewiesene Dienste</div>
        ...
        <div className="flex justify-center items-center gap-2 pt-6 cursor-pointer text-[#173968] hover:text-[#EDD22E] mb-8">
          <span className="text-[#173968]">Keine Einträge</span>
        </div>
      </div>
    </>
  )
