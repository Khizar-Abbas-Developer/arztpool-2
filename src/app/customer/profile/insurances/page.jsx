  ...
  return (
    <>
      <form className="px-[90px] py-[80px]">
        <h1 className='text-[24px] font-[600] text-[#173968]'>Versicherungen</h1>
        <div className="my-6 mx-3">
          <div className="text-[16px] leading-[24px] text-[#173968] mb-8">Um Dienste vermittelt zu bekommen, benötigen Sie eine Versicherung, die zum Dienstantritt gültig ist. Sie können hier Versicherungsinformationen hinterlegen, mit denen wir sicherstellen können, dass Sie versichert sind.</div>
        </div>
        <div>
          <div className="text-[16px] text-[#173968] font-[600] leading-[24px] my-3">Ihre Versicherungen</div>
          <div className="text-[16px] text-[#173968] leading-[24px] my-3">Mit einem Klick auf den Namen und die Nummer Ihrer Versicherung können Sie diese aufklappen und alle wesentlichen Daten einsehen.</div>
        </div>
        <hr className="mt-16" />
        <div className="text-[16px] text-[#173968] font-[600] leading-[24px] my-8">Neue Versicherung hinzufügen</div>
        ...
        <div className="flex justify-center items-center mt-20">
          <div className="sub-containers mb-[51px]">
            <span className="label-spans">Laufzeit von</span>
          ...
          <div className="sub-containers mb-[51px]">
            <span className="label-spans">Laufzeit bis</span>
            <LocalizationProvider dateAdapter={AdapterDayjs}>
              <DemoContainer components={['DesktopDatePicker']}>
                <DesktopDatePicker
                  defaultValue={dayjs('2022-04-17')}
