...
const FouthLayout = ({ userId, city_name, post_code, street, house }) => {
              ...
              <div className="sub-container">
                <div className="entryarea">
                  <input
                    ...
                    autoComplete="off"
                  />
                  <div className="labelline bg-transparent">{'Stadt'}</div>
                </div>
              </div>
            </div>
              ...
              <div className="sub-container">
                <div className="entryarea">
                  <input
                    ...
                    autoComplete="off"
                  />
                  <div className="labelline bg-transparent">{'PLZ'}</div>
                </div>
              </div>
            </div>
            <div className="col-lg-4 col-md-6 col-sm-12">
