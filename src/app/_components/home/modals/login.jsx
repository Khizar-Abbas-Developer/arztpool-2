...
import { signInStart, singInSuccess, singInFailure } from "@/redux/user/userSlice";
    ...
    return (
        <>
            <div className="modal-content" style={{ width: `100%` }}>
                <form className="modal-content-containerregister" onSubmit={handleSubmit}>
                    <div className="heading-container">
                        <h1>Willkommen!</h1>
                    </div>
                    <div className="flex flex-col">
                        <div className="">
                            <Input name="email" label={'E-Mail'} value={data.email} onChange={handleInputChange} />
                        </div>
                        <div className="">
                            <Password name="password" label={'Passwort'} value={data.password} onChange={handleInputChange} />
                        </div>
                        <div className="major-btn-and-input">
                            ...
                            <button type="submit" className="btn-1-s bg-orange-500">Anmelden</button>
                        </div>
