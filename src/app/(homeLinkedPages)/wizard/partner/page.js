      ...
      try {
        ...
        if (data.federal_state !== '' && listOfServiceArea.length === 0) {
          const response2 = await axios.get(
            `${apiUrl}/api/v1/service_area?state_id=${data.federal_state}`
          )
  ...
  return (
    <>
      <div
        ...
        style={{ display: mainLayout ? 'block' : 'none' }}
      >
        {/* 3 */}
            ...
            <div className="info-section-container">
              ...
              <div className="info-heading-text">
                <h1 className="font-[600]">
                  Um welche Art von Institution handelt es sich?
                </h1>
              </div>
          ...
          <div className="col-lg-6 col-md-12 col-sm-12 h-100 hm-wizard-right-section">
            <div className="form-section-container pt-3 bg-white hm-wizard-right-section-inner">
                ...
                <div className="items" key={0}>
                  <div className="titles">
                    <div
                      ...
                      onClick={() => handleRadioChangeOne(null, 0)}
                    >
                      <input
                        ...
                        checked={selected === 0}
                        onChange={(event) =>
                          handleRadioChangeOne(event, 0, 'mvz')
                        }
                      />
                      <label
                    ...
                    <form action="" className="form-one-radio">
                      <div>
                        ...
                        <p className="form-one-text-1">
                          Als MVZ haben Sie später im Bereich &quot;Meine
                          Daten&quot; die Möglichkeit, einzelne Betriebsstätten
                          anzulegen.
                        </p>
                        <p className="form-one-text-2 my-4">
                          Zu vertretender Arzt
                        </p>
                        <Input
                          name={'title'}
                          label={'Titel'}
                ...
                <div className="items" key={1}>
                  <div className="titles">
                    <div
                      className="form-check"
                      onClick={() =>
                        handleRadioChangeTwo(null, 1, 'individual')
                      }
                    >
                      <input
                        className="form-check-input"
                  ...
                  <div className={selected === 1 ? 'content show' : 'content'}>
                    <form action="" className="form-two-radio">
                      <Input
                        name={'mvz_name'}
                        label={'Name bzw. Praxisname'}
                        value={data.mvz_name}
                        onChange={handleInputChange}
                      />
                      <p className="form-two-text-1">
                        Falls Sie nicht wissen, welchen Praxisnamen Sie hier
                        angeben sollen, nutzen Sie einfach Ihren Namen als
                        „Praxis Vorname Nachname“. Dies können Sie später
                        jederzeit editieren
                      </p>
                      <p className="form-one-text-2 my-4">
                        Zu vertretender Arzt
              ...
              <div className="form-buttons-container">
                ...
                <button className="buttons-2" onClick={handleFirstContinue}>
      ...
      <div
        className="main-container"
        style={{ display: secondLayout ? 'block' : 'none' }}
      >
        {/* 3 */}
        {/* //Form Three container is starting from here */}
        <div className="form-two-container" style={{ display: thirdForm }}>
          ...
          <div className="col-lg-6 col-md-12 col-sm-12 hm-wizard-left-section ">
            <div className="info-section-container">
              ...
              <div className="info-heading-text">
                <h1 className="font-[600]">
                  In welchem Dienstgebiet sind Sie tätig?
                </h1>
              </div>
              <div className="info-paragraph-text">
                In wenigen Schritten ist Ihr KV-Dienst online. Fügen Sie die
            ...
            <div className="form-section-container pt-3 bg-white hm-wizard-right-section-inner">
              ...
              <div className="select-menu-containert">
                <div className="set z-50">
                  ...
                  >
                    <Option value={''} onClick={() => handleSelectChange('')}>
                      Bundesland
                    </Option>
                ...
                <div>
                  ...
                  >
                    <Option value={''} onClick={() => handleServiceArea('')}>
                      Dienstgebiet
                    </Option>
                    {listOfServiceArea.map((state, i) => {
                      return (
                        <React.Fragment key={i}>
                          <Option
                            value={state.id}
                            onClick={() => handleServiceArea(state.id)}
                          >
                            {state.surname}
                          </Option>
                        </React.Fragment>
              ...
              {/* Accordion// */}
              <div className="form-buttons-container">
                <button className="buttons-1" onClick={handleSecondBack}>
                  Zurück
                </button>
                <button className="buttons-2" onClick={handleSecondContinue}>
                  Bestätigen und weiter
                </button>
              </div>
            </div>
      ...
      <div
        className="main-container"
        style={{ display: thirdLayout ? 'block' : 'none' }}
      >
        {/* 3 */}
        {/* //Form Three container is starting from here */}
        <div className="form-two-container" style={{ display: thirdForm }}>
          ...
          <div className="col-lg-6 col-md-12 col-sm-12 hm-wizard-left-section ">
            <div className="info-section-container">
              ...
              <div className="info-paragraph-text">
                Bitte registrieren Sie Ihren Account und klicken Sie dann in der
                Bestätigungs E-Mail auf den Link, um ihre E-Mail Adresse zu
                bestätigen.
              </div>
            </div>
          </div>
            ...
            <div className="form-section-container pt-3 bg-white hm-wizard-right-section-inner">
              ...
              <div className="mx-12 mt-8">
                ...
                <p className="px-2">
                  ...
                  <span className="text-[rgb(31,185,229)]">AGB</span> und{' '}
                  <span className="text-[rgb(31,185,229)]">
              ...
              <div className="form-buttons-container mt-8">
                <button className="buttons-1" onClick={handleThirdBack}>
                  Zurück
                </button>
                <button
                  className="buttons-2"
                  onClick={handleRepresentatorRegister}
                >
                  Registrieren
                </button>
              </div>
