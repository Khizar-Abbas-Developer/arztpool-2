...
const Page = ({ children }) => {
    ...
    const navLinks = [
        { name: "Ihr Account", href: "/representative/profile/account" },
        { name: "Stammdaten", href: "/representative/profile/basedata" },
        { name: "Abrechnungsdaten", href: "/representative/profile/billing" },
        { name: "Versicherungen", href: "/representative/profile/insurances" },
        { name: "Qualifikation/Ausstattung", href: "/representative/profile/specialization" },
    ];
