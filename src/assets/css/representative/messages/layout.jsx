...
const Page = ({ children }) => {
    ...
    const navLinks = [
        { name: "", href: "/doctor/services/overview" },
        { name: "", href: "/doctor/services/marketplace" },
    ];
                ...
                <div className="w-[480px] bg-white pr-6">
                    <div className="w-full flex flex-col justify-start items-start pt-[138px] pl-[106px] gap-4">
                        <Link href={"/representative/messages"}>
                            <div onClick={handleActiveLink1} className={`w-full cursor-pointer ${firstActive ? "font-bold text-[rgb(23,85,153)]" : "text-black"} w-full mb-2 flex border-transparent border-b-2 hover:border-orange-500 hover:border-b-2`}>{"Ungelesene Nachrichten (169)"}</div>
                        </Link>
                        <Link href={"/representative/messages"}>
                            <div onClick={handleActiveLink2} className={`w-full cursor-pointer ${secondActive ? "font-bold text-[rgb(23,85,153)]" : "text-black"} w-full mb-2 flex border-transparent border-b-2 hover:border-orange-500 hover:border-b-2`}>{"Gelesene Nachrichten  (64)"}</div>
                        </Link>
                    </div>
                </div>
                {/* Right section */}
