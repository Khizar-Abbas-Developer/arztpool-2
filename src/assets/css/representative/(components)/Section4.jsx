...
const Section4 = () => {
  return (
    <>
      <div className="px-[110px] mt-2 bg-white sm:px-[10px] md:px-[25px] lg:px-[25px] xl:px-[25px] xxl:px-[25px] py-24 flex flex-col gap-8">
        <div className="text-start sm:text-center md:text-center  text-[24px] font-[600] leading-[32px] text-[#173968] xxl:ml-10">Folgende Dienste benötigen Ihre Aufmerksamkeit:</div>
        <div className="flex sm:flex-col sm:justify-center sm:items-center gap-4 md:flex-wrap md:justify-center md:items-center lg:flex-wrap lg:justify-center xl:flex-wrap xl:justify-center xl:items-center xxl:flex-wrap xxl:justify-center xxl:items-center">
          ...
          <Link href={`/representative/service/${1}`}>
            <div className="custom-hm drop-shadow-xl flex flex-col justify-between rounded-md bg-[white] border-2 hover:border-[rgb(237,109,5)] w-72 h-56 pb-9">
              <div className="w-full h-ful flex justify-between items-center px-[18px] py-[12px]">
              ...
              <span className='ribbon'>Patientenanzahlen eintragen</span>
