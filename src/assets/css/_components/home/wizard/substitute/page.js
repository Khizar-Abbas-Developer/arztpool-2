  ...
  return (
    <>
      <form className="main-container" onSubmit={handleSubstituteSubmit}>
        <div className="form-one-container" style={{ display: FirstForm }}>
          {/* left section */}
          ...
          {/* //right section */}
          <div className="right-section-container z-0">
        ...
        <div className="form-two-container" style={{ display: secondForm }}>
          {/* left section */}
          <div className="left-section-container">
            <div className="info-section-container">
              <div className="pg-progress-container">
...
//////////////////////////////////////////////////////////////////// */}
        {/* 4 */}
        {/* //Form Three container is starting from here */}
        <div className="form-two-container" style={{ display: fourthForm }}>
          {/* left section */}
          <div className="left-section-container">
            <div className="info-section-container">
              <div className="pg-progress-container">
        ...
        {/* 5 */}
        {/* //Form Three container is starting from here */}
        <div className="form-two-container" style={{ display: fifthForm }}>
          {/* left section */}
          <div className="left-section-container">
            <div className="info-section-container">
              <div className="pg-progress-container">
        ...
        {/* 6 */}
        {/* //Form Three container is starting from here */}
        <div className="form-two-container" style={{ display: sixthForm }}>
          {/* left section */}
          <div className="left-section-container">
            <div className="info-section-container">
              <div className="pg-progress-container">
